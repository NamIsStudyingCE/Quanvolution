...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/Fig1_quanvolution_pipeline.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\textwidth]{figures/Fig2_feature_comparison.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\textwidth]{figures/Fig3_breastmnist_benchmark.png}
\caption{Empirical 10-seed performance comparison on BreastMNIST ($L=2$), demonstrating quantum variance stability ($\sim 2.73\times$ lower std) and PR-AUC advantages.}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\textwidth]{figures/Fig3_octmnist_benchmark.png}
