...
1. **Quán quân ROC-AUC thuộc về Mạch tĩnh:** `Fixed Basic L2` thiết lập kỷ lục ROC-AUC cao nhất đạt **$0{,}8521 \pm 0{,}0090$**, vượt trội mô hình cổ điển đối chứng $0{,}8336$ với mức tăng $\Delta = +0{,}0186$ có ý nghĩa thống kê ($p_{\text{ttest}} = 0{,}0309, p_{\text{wilcoxon}} = 0{,}0298 < 0{,}05$). Độ lớn tác động đạt **Cohen's $d = +0{,}815$ (Large effect)**.
2. **Quán quân PR-AUC và Khả năng Bắt bệnh Hiếm:** `Fixed Strongly L2` đạt PR-AUC cao nhất bảng là **$0{,}9182 \pm 0{,}0067$**, vượt trội Classical CNN ($0{,}9041$) với ý nghĩa thống kê rất cao ($p_{\text{ttest}} = 0{,}0018, p_{\text{wilcoxon}} = 0{,}0023 < 0{,}01$) và độ lớn tác động cực lớn **Cohen's $d = +1{,}332$ (Very large effect)**.
3. **Độ ổn định phương sai vượt trội:** Độ lệch chuẩn ($\text{std}$) của các mô hình lượng tử tĩnh nhỏ hơn mạng CNN cổ điển từ $\mathbf{2{,}73\times}$ (ở ROC-AUC: $0{,}0090$ vs $0{,}0246$) đến $\mathbf{1{,}42\times}$ (ở PR-AUC: $0{,}0067$ vs $0{,}0095$), chứng minh mạch lượng tử tĩnh có khả năng kháng biến động khởi tạo xuất sắc trên dữ liệu ít mẫu.
4. **Vị thế của Trainable Models:** `Trainable Strongly` đạt Balanced Accuracy cao nhất ($0{,}6945 \pm 0{,}0428$), cải thiện $+0{,}0344$ BAcc so với `Fixed Strongly` ($0{,}6602$) với độ lớn tác động trung bình ($d = +0{,}677, p = 0{,}061$), tuy nhiên so với Classical CNN ($0{,}6875$), mức chênh lệch là không có ý nghĩa thống kê ($p = 0{,}670, d = +0{,}139$, negligible). `Trainable Basic` đạt PR-AUC cao ($0{,}9173 \pm 0{,}0184$) nhưng chưa đạt ngưỡng ý nghĩa thống kê so với CNN ($p = 0{,}0513$, ns).
...
1. **Sự Thống trị Áp đảo của Classical CNN:** Classical CNN dẫn đầu tuyệt đối trên toàn bộ 6 độ đo với ROC-AUC **$0{,}7505 \pm 0{,}0240$**, PR-AUC **$0{,}4991$** và Accuracy **$0{,}5298$**. Kiểm định thống kê khẳng định khoảng cách vượt trội áp đảo so với mô hình lượng tử tốt nhất với $p < 0{,}001$ và độ lớn tác động khổng lồ **Cohen's $d = +2{,}108$** (đối với ROC-AUC) và **$d = +1{,}874$** (đối với Balanced Accuracy).
...
* **Chuẩn Gradient $\|\nabla_\theta \mathcal{L}\|_2$ (Sanity Check):** Chuẩn gradient lượng tử dao động ổn định trong dải $[0{,}05; 0{,}25]$ trong suốt quá trình tối ưu hóa. Kết quả này xác nhận mạch 4-qubit nông hoàn toàn không bị ảnh hưởng bởi hiện tượng triệt tiêu gradient (Barren Plateaus), đúng như kỳ vọng lý thuyết đối với các mạch lượng tử có độ sâu nhỏ và toán tử đo cục bộ [17].
...
2. 🎯 **Sức mạnh của Thiên kiến Quy nạp Lượng tử với 0 tham số học:** Mạch lượng tử tĩnh (`Fixed Basic` và `Fixed Strongly`) là baseline lượng tử cực kỳ mạnh mẽ, đem lại độ ổn định phương sai cao hơn $\sim 2{,}73\times$ và PR-AUC vượt trội trên dữ liệu nhỏ mà không tiêu tốn bất kỳ tham số học nào tại tầng đặc trưng.
