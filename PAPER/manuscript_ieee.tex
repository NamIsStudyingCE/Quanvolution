...
\thanks{The authors are with the Faculty of Computer Engineering, University of Information Technology, Vietnam National University Ho Chi Minh City (VNU-HCM), Ho Chi Minh City, Vietnam (e-mails: \texttt{ng.h.nam0802@gmail.com}, \texttt{bachndx@uit.edu.vn}).}%
\thanks{Corresponding author: Duy-Xuan-Bach Nguyen (\texttt{bachndx@uit.edu.vn}).}%
