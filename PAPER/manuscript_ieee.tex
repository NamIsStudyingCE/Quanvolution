...
\thanks{H.-N. Nguyen (First Author / Primary Researcher) is with the Faculty of Computer Engineering, University of Information Technology, VNU-HCM, Ho Chi Minh City, Vietnam (e-mail: \texttt{ng.h.nam0802@gmail.com}).}%
...
\begin{tabular}{lp{3.0cm}p{3.0cm}p{2.5cm}cp{3.4cm}}
\toprule
...
Altares-L{\'o}pez et al. (2025) \cite{altares2025automatic} & Industrial / Medical & HQCNN Hybrid & ResNet-18 (Pretrained) & Inconsistent seeds & Unfair baseline; unable to isolate quantum kernel gains. \\
...
\midrule
\textbf{Classical CNN Baseline} & $0.8115 \pm 0.0281$ & \makecell{$0.6875 \pm 0.0448$ \\ \scriptsize $[0.6554, 0.7195]$} & $0.8799 \pm 0.0188$ & $0.4741 \pm 0.0830$ & \makecell{$0.8336 \pm 0.0246$ \\ \scriptsize $[0.8160, 0.8512]$} & \makecell{$0.9041 \pm 0.0095$ \\ \scriptsize $[0.8973, 0.9109]$} \\
\textbf{Fixed Basic Quanv (L2)} & $0.8192 \pm 0.0101$ & \makecell{$0.6816 \pm 0.0259$ \\ \scriptsize $[0.6631, 0.7001]$} & $0.8874 \pm 0.0058$ & $0.4874 \pm 0.0378$ & \makecell{$\mathbf{0.8521 \pm 0.0090}$ \\ \scriptsize $[0.8457, 0.8586]$} & \makecell{$0.9110 \pm 0.0065$ \\ \scriptsize $[0.9063, 0.9156]$} \\
\textbf{Trainable Basic Quanv (L2)} & $0.8186 \pm 0.0224$ & \makecell{$0.6732 \pm 0.0418$ \\ \scriptsize $[0.6433, 0.7031]$} & $0.8862 \pm 0.0145$ & $0.4814 \pm 0.0692$ & \makecell{$0.8406 \pm 0.0239$ \\ \scriptsize $[0.8235, 0.8577]$} & \makecell{$0.9173 \pm 0.0184$ \\ \scriptsize $[0.9041, 0.9304]$} \\
...
\textbf{Model Architecture} & \textbf{Accuracy} & \textbf{Balanced Acc} & \textbf{F1-Score} & \textbf{MCC} & \textbf{ROC-AUC} & \textbf{PR-AUC} \\
\midrule
\textbf{Classical CNN Baseline} & $\mathbf{0.5298 \pm 0.0239}$ & \makecell{$\mathbf{0.4433 \pm 0.0199}$ \\ \scriptsize $[0.4291, 0.4575]$} & $\mathbf{0.4792 \pm 0.0241}$ & $\mathbf{0.3092 \pm 0.0314}$ & \makecell{$\mathbf{0.7505 \pm 0.0240}$ \\ \scriptsize $[0.7333, 0.7676]$} & \makecell{$\mathbf{0.4991 \pm 0.0268}$ \\ \scriptsize $[0.4799, 0.5182]$} \\
...
\textbf{Fixed Champ (Phase 2, \texttt{random\_L1})} & $0.4799 \pm 0.0113$ & \makecell{$0.4048 \pm 0.0099$ \\ \scriptsize $[0.3977, 0.4119]$} & $0.4269 \pm 0.0133$ & $0.2391 \pm 0.0165$ & \makecell{$0.6912 \pm 0.0071$ \\ \scriptsize $[0.6861, 0.6963]$} & \makecell{$0.4443 \pm 0.0071$ \\ \scriptsize $[0.4392, 0.4494]$} \\
...
\bibitem{altares2025automatic} F.~M.~Altares-L{\'o}pez, A.~Ribeiro, and J.~J.~Garc{\'i}a-Ripoll, ``Automatic design of hybrid quantum-classical convolutional neural networks,'' \textit{Quantum Science and Technology}, vol.~10, no.~1, p.~015012, 2025.
