...
def make_qnode(n_layers=1, diff_method="backprop"):
    """
...
class TrainableQuanvLayer(nn.Module):
    ...
    """
    def __init__(self, n_layers=1, diff_method="backprop"):
        super(TrainableQuanvLayer, self).__init__()
        self.n_layers = n_layers
        self.diff_method = diff_method
        self.qnode = make_qnode(n_layers=n_layers, diff_method=diff_method)
...
class TrainableQuanvolutionalNetwork(nn.Module):
    ...
    """
    def __init__(self, num_classes=4, n_layers=1, diff_method="backprop"):
        super(TrainableQuanvolutionalNetwork, self).__init__()
        self.quanv = TrainableQuanvLayer(n_layers=n_layers, diff_method=diff_method)
